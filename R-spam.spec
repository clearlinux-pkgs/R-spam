...
Version  : 2.1.4
Release  : 13
URL      : https://cran.r-project.org/src/contrib/spam_2.1-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spam_2.1-4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1523742263
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library spam|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :


%files
%defattr(-,root,root,-)
/usr/lib64/R/library/spam/0ChangeLog
/usr/lib64/R/library/spam/0LICENSE
/usr/lib64/R/library/spam/0NEWS
