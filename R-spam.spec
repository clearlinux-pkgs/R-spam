...
Source0  : https://cran.r-project.org/src/contrib/spam_2.11-0.tar.gz
Summary  : SPArse Matrix
Group    : Development/Tools
License  : BSD-3-Clause GPL-2.0 LGPL-2.0
Requires: R-spam-lib = %{version}-%{release}
Requires: R-spam-license = %{version}-%{release}
Requires: R-Rcpp
...
%package license
Summary: license components for the R-spam package.
Group: Default

%description license
license components for the R-spam package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728053738

%install
export SOURCE_DATE_EPOCH=1728053738
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-spam
cp %{_builddir}/spam/inst/0LICENSE %{buildroot}/usr/share/package-licenses/R-spam/26881fbd7f87dd5fccbefa0024a4f8bf7b8b5b0f || :
LANG=C.UTF-8
...
/usr/lib64/R/library/spam/demo/jss10-figures-table.R
...
/usr/lib64/R/library/spam/tests/Examples/spam-Ex.Rout.save
/usr/lib64/R/library/spam/tests/demo_cholesky.R
/usr/lib64/R/library/spam/tests/demo_cholesky.Rout.save
/usr/lib64/R/library/spam/tests/demo_jss10-example1.R
/usr/lib64/R/library/spam/tests/demo_jss10-example1.Rout.save
/usr/lib64/R/library/spam/tests/demo_jss10-figures-table.R
/usr/lib64/R/library/spam/tests/demo_jss10-figures-table.Rout.save
...
/usr/lib64/R/library/spam/tests/testthat.Rout.save
...
/usr/lib64/R/library/spam/tests/testthat/test-definitions.R
...
/usr/lib64/R/library/spam/tests/testthat/test-rmvnorm.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/spam/libs/spam.so
/V4/usr/lib64/R/library/spam/libs/spam.so
/usr/lib64/R/library/spam/libs/spam.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/R-spam/26881fbd7f87dd5fccbefa0024a4f8bf7b8b5b0f
